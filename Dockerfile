...
RUN curl -L https://github.com/duckdb/duckdb/releases/download/v1.4.3/duckdb_cli-linux-${TARGETARCH}.zip -o duckdb_cli-linux.zip && unzip duckdb_cli-linux.zip -d /usr/local/bin/ && rm duckdb_cli-linux.zip
